...
export default function Contact() {
  const contactInfo = {
    phone: "+91 637 492 4164",
    email: "developer.pandiyan@gmail.com",
    address: "102 Main St, Chennai, India",
    github: "https://github.com/Pandiyan-Muthusamy",
    linkedin:
      "https://www.linkedin.com/in/pandiyan-muthusamy-developer-pandiyan/",
    instagram: "https://www.instagram.com/agent_no_46",
  };
  ...
  return (
    ...
    >
      ...
      <footer className="w-full text-center mt-44 text-xs sm:text-sm md:text-base text-gray-600">
        <p>&copy; Pandiyan Muthusamy | MERN Stack Developer @ 2024</p>
      </footer>
    </motion.div>
  );
}
